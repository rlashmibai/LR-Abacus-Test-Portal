...
export default function LoginForm({ quote }: { quote: string }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-paper p-4">
      <div className="grid w-full max-w-4xl grid-cols-1 overflow-hidden rounded-[28px] bg-surface shadow-xl ring-1 ring-line md:grid-cols-2">
        {/* Form */}
        ...
        {/* Illustration + quote */}
        <div className="relative hidden flex-col items-center justify-center gap-6 bg-brand-soft p-10 md:flex">
          <AbacusIllustration className="h-44 w-44" />
          <p className="max-w-[240px] text-balance text-center font-display text-lg italic leading-snug text-brand-dark">
            &ldquo;{quote}&rdquo;
          </p>
        </div>
      </div>
